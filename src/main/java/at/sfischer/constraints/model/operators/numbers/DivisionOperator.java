...
public class DivisionOperator extends ArithmeticOperator {
    ...
    public DivisionOperator(Node left, Node right) {
        super(left, right);
    }
    ...
    public Node evaluate() {
        ...
        if(left != null){
            ...
            return new DivisionOperator(new NumberLiteral(left), this.right);
        }
        ...
        if(right != null){
            ...
            return new DivisionOperator(this.left, new NumberLiteral(right));
        }
    ...
    public Node setVariableValues(Map<Variable, Node> values) {
        return new DivisionOperator(this.left.setVariableValues(values), this.right.setVariableValues(values));
    }
}
