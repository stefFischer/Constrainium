...
public class ConstraintMinerTest {
	...
	public void getPossibleConstraintsTest4() {
		...
		Set<Constraint> expected = new HashSet<>();
		Constraint constraint1 = new Constraint(new ForAll(new Variable("array[number]"), new LessThanOperator(new Variable(ArrayQuantifier.ELEMENT_NAME), new NumberLiteral(10))));
		expected.add(constraint1);
