...
public class IsNumericTest {
	@Test
	public void evaluateTrueLong() {
		IsNumeric i = new IsNumeric(new StringLiteral("404"));
	...
	@Test
	public void evaluateTrueDouble() {
		IsNumeric i = new IsNumeric(new StringLiteral("4.04"));
		Node result = i.evaluate();
	...
	public void evaluateFalse() {
		IsNumeric i = new IsNumeric(new StringLiteral("ONE"));
		Node result = i.evaluate();
