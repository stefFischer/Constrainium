...
public class FindLastIndexTest {
    ...
    @Test
    public void evaluateFindLastOccurrence() {
        Node array = new ArrayValues<>(TypeEnum.NUMBER, new NumberLiteral[]{
                new NumberLiteral(1),
                new NumberLiteral(2),
                new NumberLiteral(3),
    ...
    @Test
    public void evaluateReturnsLastMatchingIndex() {
        Node array = new ArrayValues<>(TypeEnum.NUMBER, new NumberLiteral[]{
                new NumberLiteral(2),
                new NumberLiteral(2),
                new NumberLiteral(2)
    ...
    @Test
    public void evaluateNestedFindLastIndex() {
        String jsonData = "{array:[{numbers:[2]},{numbers:[1,2]},{numbers:[3]}]}";
