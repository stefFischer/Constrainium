...
public class Append extends ArrayOperation {
    ...
    public void validate(ValidationContext context) {
        ...
        if (value == null) {
            context.error(this, "Append value cannot be null.");
            return;
        }
        ...
        if (!value.getReturnType().canAssignTo(arrayValues.getElementType())) {
            context.error(this, "Append value type must be compatible with the array element type.");
        }
    }
