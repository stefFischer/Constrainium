...
public class Max extends ArrayAggregation {

    private static final String FUNCTION_NAME = "arrays.max";

    public Max(Node array) {
        this(array, new Variable(ELEMENT_NAME));
    }

    public Max(Node array, Node keySelector) {
    ...
    protected ArrayAggregation createArrayAggregation(Node array, Node keySelector, Node... parameters) {
        return new Max(array, keySelector);
    }
}
